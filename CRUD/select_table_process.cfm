...
<!---<cfoutput>#URL.table_name# <br /> </cfoutput>--->
<cfset tabla = #URL.table_name# />
<!---<cfoutput> #tabla#</cfoutput>	
<cfabort--->>
<!---<cfset TABLA = #URL.table_name#/>
<cfoutput> #URL.table_name#</cfoutput>
--->
<a href="select_table.cfm">Ver todas las tablas</a>
<br />
<br />

<cfform id="form1" name="form1" method="post" action="generate_crud.cfm?tablita=#tabla# ">
<table border="1" cellspacing="2" cellpadding="2">
  <tr>
    <td height="52">Select</td>
    <td>Columna</td>
    <td>Tipo</td>
    <td>Extras</td>
    <td>Default</td>
...
<p>
  <input type="submit" name="button" id="button" value="Enviar" />
	...
	<!---
    <cfoutput>Vasija =  #vasija#</cfoutput>--->
<!---</form>--->
<hr />
</cfform>
<!---
